	...
	function onMessage(msg){
		try{
			...
			if(data.msg === 'allTxs'){
				...
				//Nostro 1			
				if(data.nvAccounts.nostro){
					$("#n1Holder").html(formatUsername(data.nvAccounts.nostro[0].accounts[0].holder));
					$("#n1Owner").html(formatUsername(data.nvAccounts.nostro[0].owner));
					$("#n1Balance").html(formatMoney(data.nvAccounts.nostro[0].accounts[0].cashBalance,data.nvAccounts.nostro[0].accounts[0].currency));
					$("#n1Currency").html(data.nvAccounts.nostro[0].accounts[0].currency);

					if(data.nvAccounts.nostro[0].accounts[0].cashBalance <= 50000){
					...
					//Nostro 2					
					$("#n2Holder").html(formatUsername(data.nvAccounts.nostro[1].accounts[0].holder));
					$("#n2Owner").html(formatUsername(data.nvAccounts.nostro[1].owner));
					$("#n2Balance").html(formatMoney(data.nvAccounts.nostro[1].accounts[0].cashBalance,data.nvAccounts.nostro[1].accounts[0].currency));
					$("#n2Currency").html(data.nvAccounts.nostro[1].accounts[0].currency);

					if(data.nvAccounts.nostro[1].accounts[0].cashBalance <= 50000){
				...
				if(data.nvAccounts.vostro[0].accounts){
					...
					$("#v1Owner").html(formatUsername(data.nvAccounts.vostro[0].owner));
					$("#v1Balance").html(formatMoney(data.nvAccounts.vostro[0].accounts[0].cashBalance,data.nvAccounts.vostro[0].accounts[0].currency));
					$("#v1Currency").html(data.nvAccounts.vostro[0].accounts[0].currency);

					if(data.nvAccounts.vostro[0].accounts[0].cashBalance <= 50000){
					...
					//Vostro 2					
					$("#v2Holder").html(formatUsername(data.nvAccounts.vostro[0].accounts[1].holder));
					$("#v2Owner").html(formatUsername(data.nvAccounts.vostro[0].owner));
					$("#v2Balance").html(formatMoney(data.nvAccounts.vostro[0].accounts[1].cashBalance,data.nvAccounts.vostro[0].accounts[1].currency));
					$("#v2Currency").html(data.nvAccounts.vostro[0].accounts[1].currency);

					if(data.nvAccounts.vostro[0].accounts[1].cashBalance <= 50000){
